var listAccounts = [
  ...
  function checkAccountVip(listAccounts){
    for (var i in listAccounts) {
        if (listAccounts[i].balance > 1000000) listAccounts[i].type = 'vip';
    }
  }

  function checkPromotionByID(listAccounts, id, money) {
      var KT = false;
      for (var i in listAccounts) 
      {
      ...
      if (KT == false) console.log("Khong co tai khoan thoa man!");
      else {
          console.log('Kiem tra tai khoan duoc nhan khuyen mai: \n');
          Show();
      }
  }
  ...
  function main(){
      checkAccountVip(listAccounts);
      console.log('Set tai khoan VIP: \n');
      Show();

      checkPromotionByID(listAccounts, 6, 333333);

      console.log('Kiem tra tai khoan la Active: \n');
